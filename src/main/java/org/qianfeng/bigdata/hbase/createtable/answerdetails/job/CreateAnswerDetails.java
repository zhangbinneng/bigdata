package org.qianfeng.bigdata.hbase.createtable.answerdetails.job;
...
import org.qianfeng.bigdata.hbase.createtable.answerdetails.mapper.AnswerDetailsMapper;
import org.qianfeng.bigdata.hbase.createtable.answerdetails.reducer.AnswerDetailsReducer;
...
public class CreateAnswerDetails{
        public static void main(String[] args) throws Exception {
            ...
            try {
                ...
                Job job = Job.getInstance(conf,"upload to hbase2");
                TableMapReduceUtil.addDependencyJars(job);// 设置依赖
                job.setJarByClass(CreateAnswerDetails.class);

                job.setMapperClass(AnswerDetailsMapper.class);
                job.setMapOutputKeyClass(Text.class);
                job.setMapOutputValueClass(NullWritable.class);


                job.setReducerClass(AnswerDetailsReducer.class);
